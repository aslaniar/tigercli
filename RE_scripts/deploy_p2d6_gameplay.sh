...
#   4 harness gates          (refused -> restore the cache, abort, deploy nothing)
#   5 deploy the exe
...
for flag in --s1-test --cache-check --equip-diff --selection-version-test --membership-sweep-test; do
